...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_agg_player_round_player ON agg_player_round_stats(player_name);
CREATE INDEX IF NOT EXISTS idx_agg_player_round_round ON agg_player_round_stats(round_id);
CREATE INDEX IF NOT EXISTS idx_agg_player_round_tournament ON agg_player_round_stats(tournament_name);
CREATE INDEX IF NOT EXISTS idx_agg_player_round_agent_role ON agg_player_round_stats(agent_role);
CREATE INDEX IF NOT EXISTS idx_agg_player_round_clutch ON agg_player_round_stats(is_clutch);
CREATE INDEX IF NOT EXISTS idx_agg_player_round_started_at ON agg_player_round_stats(started_at);
