...
CREATE INDEX IF NOT EXISTS idx_agg_tournament_tournament ON agg_tournament_stats(tournament_id);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_tournament_name ON agg_tournament_stats(tournament_name);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_entity_type ON agg_tournament_stats(entity_type);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_entity_id ON agg_tournament_stats(entity_id);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_entity_name ON agg_tournament_stats(entity_name);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_year ON agg_tournament_stats(tournament_year);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_region ON agg_tournament_stats(tournament_region);
CREATE INDEX IF NOT EXISTS idx_agg_tournament_placement ON agg_tournament_stats(placement);
