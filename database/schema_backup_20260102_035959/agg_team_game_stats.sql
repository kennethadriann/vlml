...
CREATE INDEX IF NOT EXISTS idx_agg_team_game_team ON agg_team_game_stats(team_name);
CREATE INDEX IF NOT EXISTS idx_agg_team_game_series ON agg_team_game_stats(series_id);
CREATE INDEX IF NOT EXISTS idx_agg_team_game_tournament ON agg_team_game_stats(tournament_name);
CREATE INDEX IF NOT EXISTS idx_agg_team_game_year ON agg_team_game_stats(tournament_year);
CREATE INDEX IF NOT EXISTS idx_agg_team_game_map ON agg_team_game_stats(map_name);
CREATE INDEX IF NOT EXISTS idx_agg_team_game_started_at ON agg_team_game_stats(game_started_at);
