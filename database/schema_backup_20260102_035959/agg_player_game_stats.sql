...
CREATE INDEX IF NOT EXISTS idx_agg_player_game_player ON agg_player_game_stats(player_id);
CREATE INDEX IF NOT EXISTS idx_agg_player_game_player_name ON agg_player_game_stats(player_name);
CREATE INDEX IF NOT EXISTS idx_agg_player_game_team ON agg_player_game_stats(team_name);
CREATE INDEX IF NOT EXISTS idx_agg_player_game_tournament ON agg_player_game_stats(tournament_name);
CREATE INDEX IF NOT EXISTS idx_agg_player_game_year ON agg_player_game_stats(tournament_year);
CREATE INDEX IF NOT EXISTS idx_agg_player_game_map ON agg_player_game_stats(map_name);
CREATE INDEX IF NOT EXISTS idx_agg_player_game_started_at ON agg_player_game_stats(game_started_at);
