...
from vlml.client.queries_updated import GET_SERIES_BY_TOURNAMENT, GET_TOURNAMENTS
...
async def download_raw_events(year: str):
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python download_2025_raw.py --year 2025    # Download 2025 tournaments
  python download_2025_raw.py --year 2024    # Download 2024 tournaments
  python download_2025_raw.py                # Defaults to current year
...
3. Save raw JSONL files to: data/raw_events/{year}/{tournament}/{series_id}.jsonl
    ...
    try:
        asyncio.run(download_raw_events(args.year))
    except KeyboardInterrupt:
